...
<head>
    <meta charset="UTF-8">
    <title>Invoice Revenue Report</title>
    <style>
        body {
...
<body>
    ...
    <div class="header">
        ...
        <div class="report-info">
            <div><strong>Report:</strong> Invoice Revenue (Last 12 Months)</div>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th class="right" style="width: 30%;">Total Revenue (₱)</th>
            </tr>
        </thead>
        <tbody>
            @forelse ($invoiceRevenueTable as $item)
                <tr>
                    <td>{{ $item['month'] }}</td>
    ...
    <!-- Footer -->
    <div class="footer">
        Noynay Medical Center &middot; Automatically generated financial report
    </div>
</body>
