...
<head>
    <meta charset="UTF-8">
    <title>Patient By Age Group Report</title>
    <style>
        body {
...
<body>
    ...
    <div class="header">
        ...
        <div class="report-info">
            <div><strong>Report:</strong> Patient By Age Group</div>
            <div><strong>Generated on:</strong> {{ $generated_at }}</div>
        </div>
    </div>

    <!-- Table Section -->
    <div class="section-title">Patient Age Group Summary</div>
    <table>
        <thead>
            <tr>
                <th style="width: 10%;">Age Group</th>
                <th class="right">Patient Count</th>
            </tr>
        </thead>
        <tbody>
            @forelse ($patientAgeGroups as $item)
                <tr>
                    <td>{{ $item['age_group'] }}</td>
                    <td class="right">{{ $item['patient_count'] }}</td>
                </tr>
            @empty
                <tr>
