...
const { handleSubmit, values, setErrors, setFieldValue, resetForm } = useVeeForm({
    validationSchema: formSchema,
});

const createPatient = handleSubmit((validatedValues) => {
    Object.assign(inertiaForm, validatedValues);

    inertiaForm.post(route('admin.patients.store'), {
    ...
    >
        <DialogScrollContent>
            <DialogHeader>
                ...
                <DialogDescription>Fill up patient details and information.</DialogDescription>
            </DialogHeader>
                                ...
                                <ComboboxAnchor>
                                    <div class="relative w-full max-w-sm items-center">
                                        <ComboboxInput
                                            ...
                                            :display-value="
                                                (val) => (selectedUser && getFullName(val?.last_name, val?.first_name, val?.middle_name)) ?? ''
                                            "
